...
You find the examples in the examples folder. Just read the class description and run the script. Since the object-oriented approach is used, the auxiliary classes necessary for running the examples are logically separated in other folders (packages).
