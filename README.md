...
- On Ubuntu 22.04.3 LTS, you can get an error: "OpenGL.error.Error: Attempt to retrieve context when no valid context". See a bug report: https://github.com/pygame/pygame/issues/3110
