...
The examples cover the book chapters from 2 through 4 with some changes and demonstrate GLSL programming by PyOpenGL. Pygame is used for control, windowing, and image loading.
