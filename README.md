...
The examples cover the book chapters from 2 through 4 with slight changes (that are not significantly different from the original content) and demonstrate GLSL programming by PyOpenGL. Pygame is used for control, windowing, and image loading.
