...
The examples cover the book chapters from 2 through 4 with slight changes (which are not critical for understanding the content) and demonstrate GLSL programming by PyOpenGL. Pygame is used for control and window system.
